...
Ici on souhaite ne conserver que les pêches réalisées dans le cadre des réseaux, c'est simple avec la fonctions `mef_ajouter_objectif()` : 
...
```{r}
sh_geo <- tgeo_wfs_sandre(url_wfs = "https://services.sandre.eaufrance.fr/geo/sandre",
                                      couche = "SecteurHydro") %>% 
...
```{r}
dh_geo <- tgeo_wfs_sandre(url_wfs = "https://services.sandre.eaufrance.fr/geo/topage?",
...
save(dep_geo, reg_geo, sh_geo, rh_geo, dh_geo, file = "../processed_data/poly_geo_simp.RData")
```
