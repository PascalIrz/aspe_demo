...
Pour éviter les biais d'échantillonnage dans les calculs ultérieurs, on filtre le tableau de données pour ne retenir qu'une des opérations dans ces cas. Retenons par exemple la dernière de l'année. Comme il y a quelques cas où plusieurs opérations sont enregistrées le même jour, on n'en retient qu'une.
